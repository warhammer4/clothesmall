class Mall {
    ...
    loadItems() {
        ...
        for (const key in this.storeInventory) {
            const item = this.storeInventory[key];
            const product = document.createElement('div');
            product.className - 'col-md-3 product';
            product.innerHTML = `<div class="card mb-3" style="max-width: 140px;">
        ...
        if (count < 4) {
            gift1.append(product)
        } else {
            gift2.append(product)
        }
        count++;
        }
    }
